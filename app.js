document.addEventListener('DOMContentLoaded', () => {
    const games = [
        {
            title: "Sons Of The Forest (NON DISPONIBILE)",
            version: "v2",
        ...
        {
            title: "Deep Rock Galatic (NON DISPONIBILE)",
            version: "v4",
        ...
        {
            title: "Astroneer (NON DISPONIBILE)",
            version: "v1",
        ...
        {
            title: "JoJo's Bizarre Adventure All-Star Battle R (NON DISPONIBILE)",
            version: "v1",
        ...
        {
            title: "Schedule 1 (NON DISPONIBILE)",
            version: "v2",
        ...
        },
        {
            title: "Murky Divers",
            version: "v1",
            downloadUrl: "https://files.catbox.moe/0vvlp6.rar",
            image: "https://shared.cloudflare.steamstatic.com/store_item_assets/steam/apps/2963880/582e04c544ef60fb5e3e35f0cdd8f7e8522393a0/header.jpg?t=1746516762"
        },
    ];
